...
log_file = open('training_log_both2.txt', 'w')
...
model.fit(train_images, train_labels, epochs=40, batch_size=64, callbacks=[LogCallback()])
end_time = time.time()
...
# Save the model
model.save('fashion_mnist_model_both2.h5')
